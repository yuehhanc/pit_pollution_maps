...
function addGrids(flag) {
    ...
    map_area.innerHTML = '<img src="/static/pollution_map/images/routes_5_3.png" onclick="searchPoint(event)" class="map" id="map">';
...
function saveNumClicks() {
    ...
    req.send("numClicks="+numClicks+"&category="+"Gray+Dial"+"&csrfmiddlewaretoken="+getCSRFToken());
